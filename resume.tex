...
\indentedItem{{\spaceskip  0.45em  {\bf Relevant Coursework}: Calculus (I, II, III), Linear Algebra, Mathematical Statistics (I, II), Introduction to}} 
\indentedItem{\qquad Statistical Learning, Machine Learning for Data Scientists}
\vspace{-0.3em}  
...
\actionHeader{Astronomy Citation Manager}{}
...
\begin{itemize}
    ...
    \item Used Python, Qt for the GUI, and SQLite for the local database
\end{itemize}
...
\header{Skills}
\vspace{0.2em}
\itemWithName{Technical Skills}{Python (including SciPy, NumPy, Matplotlib, Jupyter, etc.), SQL, C/C++, Unix, LaTeX, git}
