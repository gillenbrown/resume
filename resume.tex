...
\begin{itemize}
    \item Performed astrophysics resulting in four peer-reviewed scientific publications (key projects described below)
    \item Used Python to analyze data of several kinds, including tables, images, and volumetric simulation data
    \item Ran a suite of hydrodynamical simulations of galaxy formation and analyzed the outputs
...
\begin{itemize}
    ...
    \item In total, I have six years of experience analyzing simulations and four year of experience running my own
\end{itemize}
